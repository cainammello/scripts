...
APT_PROGRAMS_TO_INSTALL=(
  ...
  snapd flatpak gnome-software-plugin-flatpak virtualbox deepin-screenshot flameshot peek axel qbittorrent synaptic gnome-tweaks gnome-tweak-tool lm-sensors psensor woeusb easystroke vlc qtwayland5
  ...
  #developer
  git-all nodejs code slack-desktop sublime-text
)
